...
//help from ((https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/replace))
...
//help from ((https://stackoverflow.com/questions/49179722/regex-validate-pin-code-js))
...
const validateEmail = (email) => {
  let rgx = /^[a-zA-Z0-9+_.-]+@[a-zA-Z0-9.-]+$/g
  return rgx.test(email)
  ///help frm ((https://www.tutorialspoint.com/checking-for-valid-email-address-using-regular-expressions-in-java))
...
const validatePhoneNumber = (phoneNumber) => {
  ...
  let rgx = /^((\(\d{3}\))|\d{3})(\s|\-)?\d{3}(\s|\-)?\d{4}$/
  return phoneNumber.match(rgx)
  /// help from ((https://stackoverflow.com/questions/16699007/regular-expression-to-match-standard-10-digit-phone-number))
  // Solution code here...
};

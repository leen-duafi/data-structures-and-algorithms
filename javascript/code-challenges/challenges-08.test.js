...
const sortByChildren = (charArray) => {
  // Solution code here...
  let array = charArray.sort((a, b) => a.children.length < b.children.length ? -1 : 1);
  return array
};
